...
const logger = createModuleLogger("GeeTestV4Icon");

/**
 * GeeTest v4 Icon Component
 * Uses GeetestV4Base and implements specific icon click solving logic
 */
export function GeetestV4Icon(props: GeeTestV4CaptchaProps) {
  ...
  const handleAutoSolve = useCallback(
    async (
      ...
      logger.log(`${provider.name}: 开始执行点选 bypass...`);
      ...
      logger.log(`${provider.name}: 点选 bypass 完成`);
      return solveResult;
    },
    [captchaInfo]
  );
